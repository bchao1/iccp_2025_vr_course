...
void main() {
	...
	// We are supposed to multiply the distortion factor in the metric space
	// and convert it back to the texture coordinates.
	// However, as the operation is linear, the multiplication in the texture
	// coordinates also gives us an identical solution.
